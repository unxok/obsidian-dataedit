...
export const PropertyDateDatetime = (props: PropertyCommonProps) => {
	...
	return (
		<div
			class='dataedit-datedatetime-container'
			style={{ "justify-content": bctx.config.horizontalAlignment }}
		>
			<Show
				when={isEditing() || !bctx.config.formatDates}
				fallback={
					<span
						class='dataedit-formatted-date'
			...
			>
				<input
					...
					autofocus={!!bctx.config.formatDates}
